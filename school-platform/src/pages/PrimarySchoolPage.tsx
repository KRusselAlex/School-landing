...
import { BookOpen, Users, Award, MapPin, DollarSign, Languages, Star, TrendingUp } from 'lucide-react';
...
function HighlightCard({ icon, titleEn, titleFr, descriptionEn, descriptionFr, delay }: HighlightCardProps) {
  ...
  const highlights = [
    {
      ...
      descriptionEn: "Our dedicated teachers bring years of expertise to create a nurturing learning environment.",
      descriptionFr: "Nos enseignants dévoués apportent des années d'expertise pour créer un environnement d'apprentissage stimulant."
    },
    {
      icon: <DollarSign className="w-12 h-12" />,
      titleEn: "Affordable Tuition Fees",
      titleFr: "Frais de Scolarité Abordables",
      descriptionEn: "Quality education at reasonable costs, making excellence accessible to all families.",
      descriptionFr: "Une éducation de qualité à des coûts raisonnables, rendant l'excellence accessible à toutes les familles."
    },
    {
      icon: <Languages className="w-12 h-12" />,
      titleEn: "Perfectly Bilingual Students",
      titleFr: "Élèves Parfaitement Bilingues",
      descriptionEn: "Students achieve fluency in both English and French through our immersive program.",
      descriptionFr: "Les élèves atteignent la maîtrise de l'anglais et du français grâce à notre programme immersif."
    },
    {
      icon: <Star className="w-12 h-12" />,
      titleEn: "Attentive Administration",
      titleFr: "Administration Attentive",
      descriptionEn: "We maintain open communication with parents and prioritize student well-being.",
      descriptionFr: "Nous maintenons une communication ouverte avec les parents et priorisons le bien-être des élèves."
    },
    {
      icon: <Award className="w-12 h-12" />,
      titleEn: "Top Schools in the Region",
      titleFr: "Parmi les Meilleures Écoles",
      descriptionEn: "Recognized as one of the leading educational institutions in the area.",
      descriptionFr: "Reconnue comme l'une des principales institutions éducatives de la région."
    },
    {
      icon: <MapPin className="w-12 h-12" />,
      titleEn: "Easy Access Location",
      titleFr: "Emplacement Facile d'Accès",
      descriptionEn: "Conveniently located with excellent transportation links for families.",
      descriptionFr: "Idéalement situé avec d'excellentes liaisons de transport pour les familles."
    }
  ];
              ...
              <Card className="h-full hover:shadow-xl transition-shadow duration-300">
                <CardContent className="p-8">
                  <div className="mb-6">
                    ...
                    <h3 className="text-2xl mb-4 text-primary">{t('primary.francophone')}</h3>
                  </div>
              ...
              <Card className="h-full hover:shadow-xl transition-shadow duration-300">
                <CardContent className="p-8">
                  <div className="mb-6">
                    ...
                    <h3 className="text-2xl mb-4 text-secondary">{t('primary.anglophone')}</h3>
                  </div>
                  <div className="space-y-3">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {highlights.map((highlight, index) => (
              <HighlightCard key={index} {...highlight} delay={index * 0.1} />
            ))}
          </div>
